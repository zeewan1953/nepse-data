...
const NAV = [
  ...
  { href: "/news", label: "News", icon: icons.news, badge: true },
];
    ...
    <header className="sticky top-0 z-50">
      ...
      <div className="fixed right-4 top-20 z-[999] flex flex-col gap-2 pointer-events-none max-w-xs">
        {notif.toasts.slice(0, 3).map((t) => (
          <div
            key={t.id}
            className="pointer-events-auto flex items-start gap-2 rounded-lg border border-border bg-surface px-3 py-2 shadow-lg animate-slide-in"
