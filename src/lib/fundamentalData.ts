export type FiscalYear = "2076/77" | "2077/78" | "2078/79";

export type ThreeYearData = {
  years: FiscalYear[];
  revenue: number[];
  profit: number[];
  eps: number[];
...
const YEARS: FiscalYear[] = ["2076/77", "2077/78", "2078/79"];
...
function buildStock(
  ...
  threeYear: Omit<ThreeYearData, "years">,
  ...
  return {
    ...
    volume,
    current,
    threeYear: { years: YEARS, ...threeYear },
    ratios,
    holdings,
    quarterly,
    news,
...
export const STOCKS: StockFundamental[] = [
  buildStock(
    ...
    { revenue: [980, 1120, 1245], profit: [138, 162, 187], eps: [49.6, 58.4, 67.8], roe: [18.4, 20.2, 22.6], debt: [560, 520, 485], dividend: [32, 38, 45] },
  ...
  buildStock(
    ...
    { revenue: [1100, 1250, 1380], profit: [168, 192, 215], eps: [60.2, 69.5, 78.5], roe: [20.5, 22.4, 24.2], debt: [460, 430, 410], dividend: [40, 48, 55] },
  ...
  buildStock(
    ...
    { revenue: [930, 1040, 1150], profit: [142, 160, 175], eps: [54.5, 61.2, 68.6], roe: [19.2, 20.5, 21.5], debt: [415, 402, 395], dividend: [35, 40, 46] },
  ...
  buildStock(
    ...
    { revenue: [1200, 1360, 1520], profit: [158, 182, 205], eps: [48.5, 55.2, 61.8], roe: [17.2, 18.6, 19.8], debt: [665, 640, 620], dividend: [28, 34, 40] },
  ...
  buildStock(
    ...
    { revenue: [820, 905, 980], profit: [130, 148, 165], eps: [75.4, 83.8, 91.8], roe: [21.2, 22.5, 23.5], debt: [305, 295, 285], dividend: [50, 58, 65] },
  ...
  buildStock(
    ...
    { revenue: [850, 960, 1050], profit: [115, 132, 145], eps: [42.8, 48.5, 53.6], roe: [15.8, 16.8, 17.8], debt: [610, 595, 580], dividend: [22, 26, 30] },
  ...
  buildStock(
    ...
    { revenue: [920, 1050, 1180], profit: [126, 146, 165], eps: [41.4, 47.8, 54.2], roe: [14.6, 15.6, 16.5], debt: [745, 730, 720], dividend: [18, 22, 26] },
  ...
  buildStock(
    ...
    { revenue: [1040, 1150, 1250], profit: [138, 152, 165], eps: [44.5, 48.8, 53.0], roe: [13.8, 14.4, 14.8], debt: [875, 860, 850], dividend: [15, 18, 20] },
  ...
  buildStock(
    ...
    { revenue: [840, 940, 1020], profit: [110, 124, 135], eps: [39.2, 43.8, 47.9], roe: [14.0, 15.0, 15.8], debt: [680, 665, 650], dividend: [17, 20, 24] },
  ...
  buildStock(
    ...
    { revenue: [700, 765, 820], profit: [94, 108, 118], eps: [40.8, 46.2, 51.1], roe: [14.5, 15.5, 16.2], debt: [500, 490, 480], dividend: [20, 23, 27] },
  ...
  buildStock(
    ...
    { revenue: [810, 885, 950], profit: [118, 132, 142], eps: [46.5, 51.2, 55.4], roe: [16.2, 17.4, 18.2], debt: [545, 530, 520], dividend: [24, 28, 32] },
  ...
  buildStock(
    ...
    { revenue: [1150, 1290, 1420], profit: [154, 172, 188], eps: [37.5, 42.0, 45.8], roe: [13.8, 14.6, 15.2], debt: [955, 935, 920], dividend: [13, 16, 20] },
  ...
  buildStock(
    ...
    { revenue: [1650, 1980, 2340], profit: [310, 380, 456], eps: [74.8, 91.2, 110.4], roe: [22.8, 25.6, 28.4], debt: [380, 350, 320], dividend: [50, 60, 72] },
  ...
  buildStock(
    ...
    { revenue: [510, 570, 620], profit: [84, 94, 101], eps: [23.4, 26.0, 28.0], roe: [15.5, 16.2, 16.8], debt: [550, 535, 520], dividend: [12, 14, 16] },
  ...
  buildStock(
    ...
    { revenue: [315, 350, 380], profit: [53, 60, 65], eps: [18.8, 21.2, 23.3], roe: [12.8, 13.8, 14.5], debt: [430, 420, 410], dividend: [7, 8, 10] },
  ...
  buildStock(
    ...
    { revenue: [780, 890, 980], profit: [168, 194, 215], eps: [88.4, 102.0, 112.8], roe: [23.2, 25.0, 26.5], debt: [210, 195, 180], dividend: [64, 76, 88] },
  ...
  buildStock(
    ...
    { revenue: [118, 132, 145], profit: [25, 28, 31], eps: [13.5, 15.2, 17.0], roe: [11.8, 12.6, 13.2], debt: [295, 288, 280], dividend: [5, 6, 7] },
  ...
  buildStock(
    ...
    { revenue: [96, 108, 118], profit: [20, 23, 25], eps: [13.8, 15.6, 17.2], roe: [11.4, 12.2, 12.8], debt: [238, 228, 220], dividend: [4, 5, 6] },
  ...
  buildStock(
    ...
    { revenue: [195, 220, 245], profit: [36, 42, 48], eps: [22.5, 26.4, 30.2], roe: [16.0, 17.4, 18.5], debt: [95, 90, 85], dividend: [10, 12, 15] },
  ...
  buildStock(
    ...
    { revenue: [790, 850, 890], profit: [88, 95, 98], eps: [69.2, 73.5, 76.8], roe: [14.8, 15.0, 15.2], debt: [132, 125, 120], dividend: [30, 32, 35] },
