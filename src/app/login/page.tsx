        ...
        <div className="w-full max-w-md">
          ...
          <div className="animate-[fadeIn_0.3s_ease-out] text-center">
            ...
            <p className="mt-8 text-center text-xs text-gray-500">
              Having trouble?{" "}
              <a href="https://wa.me/9779705100088" target="_blank" rel="noopener noreferrer" className="text-[#25D366] hover:underline font-medium inline-flex items-center gap-1">
