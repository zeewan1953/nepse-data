...
function main() {
  ...
  checkNode();
  if (checkVercel()) { log(''); log('Vercel CLI is already installed, no need to reinstall.'); log(''); console.log(JSON.stringify({ status: 'already_installed', message: 'Vercel CLI already installed' })); process.exit(0); }
  ...
  if (checkVercel()) { log(''); log('========================================'); log('Vercel CLI installed successfully!'); log('========================================'); log(''); log('Next step: Run login script to authorize'); log(''); console.log(JSON.stringify({ status: 'success', message: 'Vercel CLI installed successfully' })); }
